        ...
        <div>
            ...
            >
                ...
                <div className="main-tabs">
                    ...
                    <button 
                        className={`tab-btn ${activeTab === 'operadores-gruas' ? 'active' : ''}`}
                            ...
                            <div className="tab-pane">
                                ...
                                {loading.clientes ? (
                                    ...
                                    >
                                        ...
                                        <button onClick={fetchClientes} className="retry-button">
                        ...
                        {activeTab === 'operadores-gruas' && (
                            <div className="tab-pane">
                                ...
                                <div className="sub-tabs">
                                    <button 
                                        className={`sub-tab-btn ${activeSubTab === 'operadores' ? 'active' : ''}`}
                                        onClick={() => setActiveSubTab('operadores')}
                                    >
                                        <i className="fas fa-hard-hat"></i> Operadores
                                    </button>
                                    <button 
                                        className={`sub-tab-btn ${activeSubTab === 'gruas' ? 'active' : ''}`}
                                        onClick={() => setActiveSubTab('gruas')}
                                    >
                                        <i className="fas fa-truck-pickup"></i> Grúas
                                    </button>
                                    <button 
                                        className={`sub-tab-btn ${activeSubTab === 'asignacion' ? 'active' : ''}`}
                                    ...
                                    >
                                            ...
                                            <div className="sub-tab-pane">
                                                ...
                                                {loading.operadores ? (
                                                    ...
                                                    <div className="error-message">
                                                        ...
                                                        <button onClick={fetchOperadores} className="retry-button">
                                                            <i className="fas fa-redo"></i> Reintentar
                                                        </button>
                                                    </div>
                                                ) : operadores.length === 0 ? (
                                            ...
                                            <div className="sub-tab-pane">
                                                ...
                                                {loading.gruas ? (
                                                    ...
                                                    <div className="error-message">
                                                        ...
                                                        <button onClick={fetchGruas} className="retry-button">
                                                            <i className="fas fa-redo"></i> Reintentar
                                                        </button>
                                                    </div>
                                                ) : gruas.length === 0 ? (
                                        ...
                                        {activeSubTab === 'asignacion' && (
                                            <div className="sub-tab-pane">
                                                ...
                                                <motion.div 
                                                    className="asignacion-container"
                                                    initial={{ opacity: 0, y: 20 }}
                                                    animate={{ opacity: 1, y: 0 }}
                                                    transition={{ duration: 0.5 }}
                                                >
                                                    ...
                                                    <motion.div 
                                                        className="asignaciones-actuales"
